...
public class Mitarbeiter_Springer_Rufen extends Activity implements DelayedConfirmationView.DelayedConfirmationListener {

    TeleportClient mTeleportClient;
    TeleportClient.OnSyncDataItemTask mOnSyncDataItemTask;

    private DelayedConfirmationView delayedconfirmationview_springer;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        DelayedConfirmationView delayedconfirmationview_springer           =   (DelayedConfirmationView)      findViewById(R.id.delayed_confirmation_springer_view);

        delayedconfirmationview_springer.setTotalTimeMs(5000);
        delayedconfirmationview_springer.setListener(this);
        delayedconfirmationview_springer.start();
